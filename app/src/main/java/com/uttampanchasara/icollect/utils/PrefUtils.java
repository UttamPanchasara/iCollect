package com.uttampanchasara.icollect.utils;
...
public class PrefUtils {
    ...
    @Nullable
    public static final String TOKEN = "pref_app_token";
    public static final String PREF_LANG_LOCALE = "pref_lang_locale";
    @Nullable
    ...
    private static PrefUtils prefsInstance;
     ...
     */
    public static PrefUtils init(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new PrefUtils(context);
        }
    ...
    public static void setSecondaryEmail() {
